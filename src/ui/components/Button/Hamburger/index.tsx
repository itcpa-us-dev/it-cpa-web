...
const HamburgerButton = ({ className }: HamburgerProps) => {
	let classes = `hamburger-button ${className ? className : ''}`;
	...
	return (
		<div className={classes} onClick={handleClickHamburgerButton}>
			<svg
				className={`bars ${headbarOpen ? 'active' : ''}`}
				viewBox="0 0 100 100">
				<path
					className="line top"
