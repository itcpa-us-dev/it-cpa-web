...
const PrivacyPolicy = () => {
	...
	const policyData =
		language === 'vn' ? data.vn.privacyPolicy : data.en.privacyPolicy;
	const contact = language === 'vn' ? data.vn.firmContact : data.en.firmContact;
	return (
		<div className="firm-info">
			<section className="firm-info__hero">
				<h3>{policyData.generalCompanyName}</h3>
				<h1>{policyData.generalTitle}</h1>
				<p>{policyData.generalEffectiveDate}</p>
			...
			<section className="firm-info__content">
				<div className="firm-info__content__navigation">
					...
					<nav className="firm-info__content__navigation__list">
						<ul>
							{policyData.contentList.map((item, index) => {
								return (
									<li
